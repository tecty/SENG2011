  ...
  <v-card flat>
    ...
    <v-form ref="form" @submit.prevent="submit">
      <v-container fluid grid-list-xl>
        <v-layout>
          <div>
            <div class="headline">Edit your post</div>
            <span class="grey--text">only for active poster</span>
          </div>
        </v-layout>
      ...
      <v-layout justify-center>
        <v-flex xs3 md4 row>
          <v-card dark color="accent">
            <v-text-field v-model="form.title" label="Location *" required></v-text-field>
          </v-card>
        </v-flex>
        <v-flex xs3 md4>
          <v-card dark color="accent">
      ...
      <v-layout row justify-center>
        <v-flex xs3 md4>
          <v-card dark color="primary">
            <v-text-field v-model="form.peopleNum" label="PeopleCount" required></v-text-field>
          </v-card>
        </v-flex>
        <v-flex xs3 md4>
          <v-card dark color="primary">
            <v-text-field v-model="form.menu" label="Menu" required></v-text-field>
          </v-card>
        </v-flex>
      </v-layout>
      <v-layout row justify-center>
